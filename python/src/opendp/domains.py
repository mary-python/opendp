...
def _atom_domain_get_bounds_closed(
    ...
    [_atom_domain_get_bounds_closed in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn._atom_domain_get_bounds_closed.html)
...
def _atom_domain_nan(
    ...
    [_atom_domain_nan in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn._atom_domain_nan.html)
...
def _lazyframe_from_domain(
    ...
    [_lazyframe_from_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn._lazyframe_from_domain.html)
...
def _series_domain_get_element_domain(
    ...
    [_series_domain_get_element_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn._series_domain_get_element_domain.html)
...
def atom_domain(
    ...
    [atom_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn.atom_domain.html)
...
def datetime_domain(
    ...
    [datetime_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn.datetime_domain.html)
...
def option_domain(
    ...
    [option_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn.option_domain.html)
...
def series_domain(
    ...
    [series_domain in Rust documentation.](https://docs.rs/opendp/0.13.0-nightly.20250523.1/opendp/domains/fn.series_domain.html)
