...
def make_stable_expr(
    ...
    [make_stable_expr in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_stable_expr.html)
...
def make_stable_lazyframe(
    ...
    [make_stable_lazyframe in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_stable_lazyframe.html)
