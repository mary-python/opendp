...
#'
#' [atom_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/domains/fn.atom_domain.html)
#'
#' @concept domains
...
#'
#' [option_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/domains/fn.option_domain.html)
#'
#' @concept domains
