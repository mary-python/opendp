...
#'
#' [accuracy_to_discrete_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.accuracy_to_discrete_gaussian_scale.html)
#'
#' **Proof Definition:**
#'
...
accuracy_to_discrete_gaussian_scale <- function(
  ...
  log_ <- new_constructor_log("accuracy_to_discrete_gaussian_scale", "accuracy", new_hashtab(
...
#'
#' [accuracy_to_discrete_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.accuracy_to_discrete_laplacian_scale.html)
#'
#' **Proof Definition:**
#'
...
accuracy_to_discrete_laplacian_scale <- function(
  ...
  log_ <- new_constructor_log("accuracy_to_discrete_laplacian_scale", "accuracy", new_hashtab(
    list("accuracy", "alpha", "T"),
    list(accuracy, alpha, .T)
  ))
...
#'
#' [accuracy_to_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.accuracy_to_gaussian_scale.html)
#'
#' @concept accuracy
#' @param accuracy Desired accuracy. A tolerance for how far values may diverge from the input to the mechanism.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
accuracy_to_gaussian_scale <- function(
  ...
  log_ <- new_constructor_log("accuracy_to_gaussian_scale", "accuracy", new_hashtab(
    list("accuracy", "alpha", "T"),
    list(accuracy, alpha, .T)
  ))
...
#'
#' [accuracy_to_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.accuracy_to_laplacian_scale.html)
#'
#' @concept accuracy
#' @param accuracy Desired accuracy. A tolerance for how far values may diverge from the input to the mechanism.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
accuracy_to_laplacian_scale <- function(
  ...
  log_ <- new_constructor_log("accuracy_to_laplacian_scale", "accuracy", new_hashtab(
    list("accuracy", "alpha", "T"),
    list(accuracy, alpha, .T)
  ))
...
#'
#' [discrete_gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.discrete_gaussian_scale_to_accuracy.html)
#'
#' **Proof Definition:**
#'
...
discrete_gaussian_scale_to_accuracy <- function(
  ...
  log_ <- new_constructor_log("discrete_gaussian_scale_to_accuracy", "accuracy", new_hashtab(
    list("scale", "alpha", "T"),
    list(scale, alpha, .T)
  ))
...
#'
#' [discrete_laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.discrete_laplacian_scale_to_accuracy.html)
#'
#' **Proof Definition:**
#'
...
discrete_laplacian_scale_to_accuracy <- function(
  ...
  log_ <- new_constructor_log("discrete_laplacian_scale_to_accuracy", "accuracy", new_hashtab(
    list("scale", "alpha", "T"),
    list(scale, alpha, .T)
  ))
...
#'
#' [gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.gaussian_scale_to_accuracy.html)
#'
#' @concept accuracy
#' @param scale Gaussian noise scale.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
gaussian_scale_to_accuracy <- function(
  ...
  log_ <- new_constructor_log("gaussian_scale_to_accuracy", "accuracy", new_hashtab(
    list("scale", "alpha", "T"),
    list(scale, alpha, .T)
  ))
...
#'
#' [laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.1-nightly.20250926.1/opendp/accuracy/fn.laplacian_scale_to_accuracy.html)
#'
#' @concept accuracy
...
laplacian_scale_to_accuracy <- function(
  ...
  log_ <- new_constructor_log("laplacian_scale_to_accuracy", "accuracy", new_hashtab(
    list("scale", "alpha", "T"),
    list(scale, alpha, .T)
  ))
