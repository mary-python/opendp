...
#'
#' [accuracy_to_discrete_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.accuracy_to_discrete_gaussian_scale.html)
#'
#' **Proof Definition:**
#'
...
#'
#' [accuracy_to_discrete_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.accuracy_to_discrete_laplacian_scale.html)
#'
#' **Proof Definition:**
#'
...
#'
#' [accuracy_to_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.accuracy_to_gaussian_scale.html)
#'
#' @concept accuracy
#' @param accuracy Desired accuracy. A tolerance for how far values may diverge from the input to the mechanism.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
#'
#' [accuracy_to_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.accuracy_to_laplacian_scale.html)
#'
#' @concept accuracy
#' @param accuracy Desired accuracy. A tolerance for how far values may diverge from the input to the mechanism.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
#'
#' [discrete_gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.discrete_gaussian_scale_to_accuracy.html)
#'
#' **Proof Definition:**
#'
...
#'
#' [discrete_laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.discrete_laplacian_scale_to_accuracy.html)
#'
#' **Proof Definition:**
#'
...
#'
#' [gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.gaussian_scale_to_accuracy.html)
#'
#' @concept accuracy
#' @param scale Gaussian noise scale.
#' @param alpha Statistical significance, level-`alpha`, or (1. - `alpha`)100% confidence. Must be within (0, 1].
...
#'
#' [laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.14.2-nightly.20260315.1/opendp/accuracy/fn.laplacian_scale_to_accuracy.html)
#'
#' @concept accuracy
