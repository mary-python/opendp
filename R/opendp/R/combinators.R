...
#'
#' [make_adaptive_composition in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_adaptive_composition.html)
#'
#' **Citations:**
#'
...
make_adaptive_composition <- function(
  ...
  .QO <- rt_canon(get_distance_type(output_measure))
  .T.d_in <- rt_canon(get_distance_type(input_metric))
  .T.d_mids <- rt_canon(new_runtime_type(origin = "Vec", args = list(.QO)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, output_measure, d_in, d_mids, .QO, .T.d_in, .T.d_mids,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_approximate in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_approximate.html)
#'
#' @concept combinators
...
make_basic_composition <- function(
  ...
  .Deprecated(msg = "This function has been renamed: use :py:func:`~opendp.combinators.make_composition` instead.")
  assert_features("contrib")

  # Standardize type arguments.
  .T.measurements <- rt_canon(new_runtime_type(origin = "Vec", args = list("AnyMeasurementPtr")))
...
#' Required features: `contrib`
#'
#' [make_chain_mt in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_chain_mt.html)
#'
#' @concept combinators
...
#' Required features: `contrib`
#'
#' [make_chain_pm in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_chain_pm.html)
#'
#' @concept combinators
...
#' Required features: `contrib`
#'
#' [make_chain_tt in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_chain_tt.html)
#'
#' @concept combinators
...
#' Required features: `contrib`
#'
#' [make_fix_delta in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_fix_delta.html)
#'
#' @concept combinators
...
#' Required features: `contrib`
#'
#' [make_fixed_approxDP_to_approxDP in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_fixed_approxDP_to_approxDP.html)
#'
#' @concept combinators
#' @param measurement a measurement with a privacy measure to be casted
#' @return Measurement
...
#' Required features: `contrib`
#'
#' [make_fully_adaptive_composition in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_fully_adaptive_composition.html)
#'
#' **Citations:**
#'
...
#'
#' [make_population_amplification in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_population_amplification.html)
#'
...
#' Required features: `contrib`
#'
#' [make_privacy_filter in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_privacy_filter.html)
#'
#' **Citations:**
#'
...
make_privacy_filter <- function(
  ...
  # Standardize type arguments.
  .T.d_in <- rt_canon(get_distance_type(odometer_input_metric(odometer)))
  .T.d_out <- rt_canon(get_distance_type(odometer_output_measure(odometer)))
  ...
  output <- .Call(
    ...
    odometer, d_in, d_out, .T.d_in, .T.d_out,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_pureDP_to_zCDP in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_pureDP_to_zCDP.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_select_private_candidate in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_select_private_candidate.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `DI`
...
#' Required features: `contrib`
#'
#' [make_sequential_composition in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_sequential_composition.html)
#'
#' **Citations:**
#'
#' * [LW22 Composition Theorems for Interactive Differential Privacy](https://arxiv.org/abs/2207.09397)
...
make_sequential_composition <- function(
  ...
  .Deprecated(msg = "This function has been renamed: use :py:func:`~opendp.combinators.make_adaptive_composition` instead.")
  assert_features("contrib")
...
#' Required features: `contrib`
#'
#' [make_zCDP_to_approxDP in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/combinators/fn.make_zCDP_to_approxDP.html)
#'
#' @concept combinators
#' @param measurement a measurement with a privacy measure to be casted
#' @return Measurement
