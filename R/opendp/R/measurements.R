...
#'
#' [make_alp_queryable in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_alp_queryable.html)
#'
#' **Citations:**
#'
...
make_alp_queryable <- function(
  ...
  .CI <- rt_canon(get_value_type(get_carrier_type(input_domain)))
  .T.value_limit <- rt_canon(new_runtime_type(origin = "Option", args = list(.CI)))
  .T.size_factor <- rt_canon(new_runtime_type(origin = "Option", args = list("u32")))
  .T.alpha <- rt_canon(new_runtime_type(origin = "Option", args = list("u32")))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, scale, total_limit, value_limit, size_factor, alpha, .CI, .T.value_limit, .T.size_factor, .T.alpha,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_canonical_noise in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_canonical_noise.html)
#'
#' **Citations:**
#'
...
make_canonical_noise <- function(
  ...
  # Standardize type arguments.
  .T.d_out <- rt_canon(new_runtime_type(origin = "Tuple", args = list("f64", "f64")))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, d_in, d_out, .T.d_out,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_gaussian in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_gaussian.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `DI`
...
make_gaussian <- function(
  ...
  .T.k <- rt_canon(new_runtime_type(origin = "Option", args = list("i32")))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, scale, k, .MO, .T.k,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_gaussian_threshold in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_gaussian_threshold.html)
#'
#' **Citations:**
#'
...
make_gaussian_threshold <- function(
  ...
  .TV <- rt_canon(get_value_type(get_carrier_type(input_domain)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, scale, threshold, k, .MO, .TV, .T.k,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_geometric in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_geometric.html)
#'
#' **Citations:**
#'
...
make_geometric <- function(
  ...
  .T <- rt_canon(get_atom(get_carrier_type(input_domain)))
  .OptionT <- rt_canon(new_runtime_type(origin = "Option", args = list(new_runtime_type(origin = "Tuple", args = list(.T, .T)))))
...
#' Required features: `contrib`
#'
#' [make_laplace in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_laplace.html)
#'
#' **Citations:**
#'
#' * [GRS12 Universally Utility-Maximizing Privacy Mechanisms](https://theory.stanford.edu/~tim/papers/priv.pdf)
...
#' Required features: `contrib`
#'
#' [make_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_laplace_threshold.html)
#'
#' **Citations:**
#'
#' * [Rogers23 A Unifying Privacy Analysis Framework for Unknown Domain Algorithms in Differential Privacy](https://arxiv.org/abs/2309.09170)
...
#' Required features: `contrib`
#'
#' [make_noise in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_noise.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `DI`
...
make_noise <- function(
  ...
  output <- .Call(
    ...
    input_domain, input_metric, output_measure, scale, k, .T.k,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_noise_threshold in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_noise_threshold.html)
#'
#' **Citations:**
#'
#' * [Rogers23 A Unifying Privacy Analysis Framework for Unknown Domain Algorithms in Differential Privacy](https://arxiv.org/abs/2309.09170)
...
make_noise_threshold <- function(
  ...
  output <- .Call(
    ...
    input_domain, input_metric, output_measure, scale, threshold, k, .TV, .T.k,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_noisy_max in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_noisy_max.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_noisy_top_k in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_noisy_top_k.html)
#'
#' **Citations:**
#'
#' * [MS20 Permute-and-Flip: A New Mechanism for Differentially Private Selection](https://arxiv.org/abs/2010.12603)
...
#' Required features: `contrib`
#'
#' [make_private_quantile in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_private_quantile.html)
#'
#' **Citations:**
#'
...
make_private_quantile <- function(
  ...
  .T.candidates <- rt_canon(new_runtime_type(origin = "Vec", args = list(.T)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, output_measure, candidates, alpha, scale, .T, .T.candidates,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_randomized_response.html)
#'
#' **Citations:**
#'
...
make_randomized_response <- function(
  ...
  .T.categories <- rt_canon(new_runtime_type(origin = "Vec", args = list(.T)))
  ...
  output <- .Call(
    ...
    categories, prob, .T, .T.categories,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_randomized_response_bitvec in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_randomized_response_bitvec.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_randomized_response_bool.html)
#'
#' **Citations:**
#'
#' * [Warner65 Randomized Response: A Survey Technique for Eliminating Evasive Answer Bias](https://doi.org/10.1080/01621459.1965.10480775)
...
#' Required features: `contrib`
#'
#' [make_report_noisy_max_gumbel in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/measurements/fn.make_report_noisy_max_gumbel.html)
#'
#' **Citations:**
#'
#' * [MS20 Permute-and-Flip: A New Mechanism for Differentially Private Selection](https://arxiv.org/abs/2010.12603)
...
make_report_noisy_max_gumbel <- function(
  ...
  .Deprecated(msg = "Use :py:func:`~opendp.measurements.make_noisy_max` instead.")
  assert_features("contrib")
...
#'
#' This constructor only returns a valid measurement if for every pair of elements \eqn{x, x'} in `input_domain`,
...
#' if \eqn{x, x'} are `d_in`-close under `input_metric`, `privacy_map(d_in)` does not raise an exception,
...
#' @return Measurement
#' @export
make_user_measurement <- function(
  input_domain,
  input_metric,
  output_measure,
  function_,
  ...
  log_ <- new_constructor_log("make_user_measurement", "measurements", new_hashtab(
  ...
  # Call wrapper function.
  output <- .Call(
    "measurements__make_user_measurement",
...
#' @return Measurement
#' @export
then_user_measurement <- function(
  lhs,
  output_measure,
  function_,
  privacy_map,
  ...
  log_ <- new_constructor_log("then_user_measurement", "measurements", new_hashtab(
    list("output_measure", "function", "privacy_map", "TO"),
    list(output_measure, function_, privacy_map, .TO)
  ))
