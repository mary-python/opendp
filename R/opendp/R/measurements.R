...
#'
#' [debias_randomized_response_bitvec in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.debias_randomized_response_bitvec.html)
#'
...
#' Required features: `contrib`
#'
#' [make_alp_queryable in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_alp_queryable.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_gaussian in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_gaussian.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `D`
...
#' Required features: `contrib`
#'
#' [make_geometric in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_geometric.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_laplace in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_laplace.html)
#'
#' **Citations:**
#'
#' * [GRS12 Universally Utility-Maximizing Privacy Mechanisms](https://theory.stanford.edu/~tim/papers/priv.pdf)
...
#'
#' [make_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_laplace_threshold.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_randomized_response.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_randomized_response_bitvec in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_randomized_response_bitvec.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_randomized_response_bool.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_report_noisy_max_gumbel in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250314.1/opendp/measurements/fn.make_report_noisy_max_gumbel.html)
#'
#' **Supporting Elements:**
#'
