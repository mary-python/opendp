...
`_extrinsic_metric_descriptor` <- function(
  metric
) {
  # No type arguments to standardize.
  log_ <- new_constructor_log("_extrinsic_metric_descriptor", "metrics", new_hashtab(
    list("metric"),
    list(metric)
  ))
  ...
  output <- .Call(
    "metrics___extrinsic_metric_descriptor",
    metric,
    log_, PACKAGE = "opendp")
  output
}
...
#'
#' [absolute_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/struct.AbsoluteDistance.html)
#'
#' @concept metrics
...
#'
#' [l01inf_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/type.L01InfDistance.html)
#'
#' @concept metrics
...
#'
#' [l02inf_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/type.L02InfDistance.html)
#'
#' @concept metrics
#' @param metric The metric used to compute distance between partitions.
#' @return Metric
...
#'
#' [l1_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/type.L1Distance.html)
#'
#' @concept metrics
#' @param .T undocumented
#' @return Metric
...
#'
#' [l2_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/type.L2Distance.html)
#'
#' @concept metrics
#' @param .T undocumented
#' @return Metric
...
#'
#' [linf_distance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/metrics/struct.LInfDistance.html)
#'
#' @concept metrics
