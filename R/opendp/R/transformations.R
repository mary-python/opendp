...
#'
#' [choose_branching_factor in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.choose_branching_factor.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_b_ary_tree in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_b_ary_tree.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_bounded_float_checked_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_bounded_float_checked_sum.html)
#'
#' **Citations:**
#'
...
make_bounded_float_checked_sum <- function(
  ...
  .T <- rt_canon(get_atom_or_infer(.S, get_first(bounds)))
  .S <- rt_substitute(.S, .T = .T)
  .T.bounds <- rt_canon(new_runtime_type(origin = "Tuple", args = list(.T, .T)))
  ...
  output <- .Call(
    ...
    size_limit, bounds, .S, .T, .T.bounds,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_bounded_float_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_bounded_float_ordered_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_bounded_int_monotonic_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_bounded_int_monotonic_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_bounded_int_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_bounded_int_ordered_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_bounded_int_split_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_bounded_int_split_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_cast in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_cast.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_cast_default in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_cast_default.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TIA>>`
...
make_cast_default <- function(
  ...
  .TIA <- rt_canon(get_atom(get_type(input_domain)))
  .M <- rt_canon(get_type(input_metric))
...
#' Required features: `contrib`
#'
#' [make_cast_inherent in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_cast_inherent.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TIA>>`
...
#' Required features: `contrib`
#'
#' [make_cdf in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_cdf.html)
#'
#' **Supporting Elements:**
#'
#' * Input Type:     `Vec<TA>`
...
#' Required features: `contrib`
#'
#' [make_clamp in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_clamp.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TA>>`
...
make_clamp <- function(
  ...
  # Standardize type arguments.
  .TA <- rt_canon(get_atom(get_type(input_domain)))
  .T.bounds <- rt_canon(new_runtime_type(origin = "Tuple", args = list(.TA, .TA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, bounds, .TA, .T.bounds,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_consistent_b_ary_tree in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_consistent_b_ary_tree.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_count in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_count.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_count_by in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_count_by.html)
#'
#' **Citations:**
#'
...
#' Required features: `contrib`
#'
#' [make_count_by_categories in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_count_by_categories.html)
#'
#' **Citations:**
#'
#' * [GRS12 Universally Utility-Maximizing Privacy Mechanisms](https://theory.stanford.edu/~tim/papers/priv.pdf)
...
make_count_by_categories <- function(
  ...
  .T.categories <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TIA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, categories, null_category, .MO, .TOA, .TIA, .T.categories,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_count_distinct in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_count_distinct.html)
#'
#' **Citations:**
#'
#' * [GRS12 Universally Utility-Maximizing Privacy Mechanisms](https://theory.stanford.edu/~tim/papers/priv.pdf)
...
#' Required features: `contrib`
#'
#' [make_create_dataframe in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_create_dataframe.html)
#'
#' **Supporting Elements:**
#'
...
make_create_dataframe <- function(
  ...
  .T.col_names <- rt_canon(new_runtime_type(origin = "Vec", args = list(.K)))
...
#' Required features: `contrib`
#'
#' [make_df_cast_default in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_df_cast_default.html)
#'
#' **Supporting Elements:**
#'
...
make_df_cast_default <- function(
  ...
  .TK <- rt_canon(get_atom(get_type(input_domain)))
  .M <- rt_canon(get_type(input_metric))
...
#' Required features: `contrib`
#'
#' [make_df_is_equal in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_df_is_equal.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `DataFrameDomain<TK>`
...
#' Required features: `contrib`
#'
#' [make_drop_null in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_drop_null.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_find in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_find.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TIA>>`
...
make_find <- function(
  ...
  output <- .Call(
    ...
    input_domain, input_metric, categories, .TIA, .T.categories,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_find_bin in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_find_bin.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TIA>>`
...
make_find_bin <- function(
  ...
  # Standardize type arguments.
  .TIA <- rt_canon(get_atom(get_type(input_domain)))
  .T.edges <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TIA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, edges, .TIA, .T.edges,
    log_, PACKAGE = "opendp")
  output
}
...
#'
#' [make_identity in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_identity.html)
#'
...
#' Required features: `contrib`
#'
#' [make_impute_constant in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_impute_constant.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<DIA>`
...
make_impute_constant <- function(
  ...
  # Standardize type arguments.
  .T.constant <- rt_canon(get_atom(get_type(input_domain)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, constant, .T.constant,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_impute_uniform_float in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_impute_uniform_float.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TA>>`
...
#' Required features: `contrib`
#'
#' [make_index in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_index.html)
#'
#' **Supporting Elements:**
#'
...
make_index <- function(
  ...
  .T.categories <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TOA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, categories, null, .TOA, .T.categories,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_is_equal in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_is_equal.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TIA>>`
...
#' Required features: `contrib`
#'
#' [make_is_null in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_is_null.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<DIA>`
...
#' Required features: `contrib`
#'
#' [make_lipschitz_float_mul in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_lipschitz_float_mul.html)
#'
#' **Supporting Elements:**
#'
...
make_lipschitz_float_mul <- function(
  ...
  # Standardize type arguments.
  .TA <- rt_canon(get_atom(get_carrier_type(input_domain)))
  .T.bounds <- rt_canon(new_runtime_type(origin = "Tuple", args = list(.TA, .TA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, constant, bounds, .TA, .T.bounds,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_mean in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_mean.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<T>>`
...
#' Required features: `contrib`
#'
#' [make_metric_bounded in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_metric_bounded.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `D`
...
#' Required features: `contrib`
#'
#' [make_metric_unbounded in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_metric_unbounded.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `D`
...
#' Required features: `contrib`
#'
#' [make_ordered_random in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_ordered_random.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `D`
...
#' Required features: `contrib`
#'
#' [make_quantile_score_candidates in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_quantile_score_candidates.html)
#'
#' **Citations:**
#'
...
make_quantile_score_candidates <- function(
  ...
  # Standardize type arguments.
  .TIA <- rt_canon(get_atom(get_type(input_domain)))
  .T.candidates <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TIA)))
  ...
  output <- .Call(
    ...
    input_domain, input_metric, candidates, alpha, .TIA, .T.candidates,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_quantiles_from_counts in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_quantiles_from_counts.html)
#'
#' **Supporting Elements:**
#'
#' * Input Type:     `Vec<TA>`
...
make_quantiles_from_counts <- function(
  ...
  .T.bin_edges <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TA)))
  .T.alphas <- rt_canon(new_runtime_type(origin = "Vec", args = list(.F)))
  ...
  output <- .Call(
    ...
    bin_edges, alphas, interpolation, .TA, .F, .T.bin_edges, .T.alphas,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_resize in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_resize.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `VectorDomain<AtomDomain<TA>>`
...
make_resize <- function(
  ...
  output <- .Call(
    ...
    input_domain, input_metric, size, constant, .MO, .T.constant,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_select_column in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_select_column.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_float_checked_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_float_checked_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_float_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_float_ordered_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_int_checked_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_int_checked_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_int_monotonic_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_int_monotonic_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_int_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_int_ordered_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sized_bounded_int_split_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sized_bounded_int_split_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_split_dataframe in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_split_dataframe.html)
#'
#' **Supporting Elements:**
#'
...
make_split_dataframe <- function(
  ...
  output <- .Call(
    ...
    separator, col_names, .K, .T.col_names,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_split_lines in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_split_lines.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `AtomDomain<String>`
...
#' Required features: `contrib`
#'
#' [make_split_records in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_split_records.html)
#'
#' **Supporting Elements:**
#'
...
#' Required features: `contrib`
#'
#' [make_subset_by in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_subset_by.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `DataFrameDomain<TK>`
...
make_subset_by <- function(
  ...
  .T.keep_columns <- rt_canon(new_runtime_type(origin = "Vec", args = list(.TK)))
  ...
  output <- .Call(
    ...
    indicator_column, keep_columns, .TK, .T.keep_columns,
    log_, PACKAGE = "opendp")
  output
}
...
#' Required features: `contrib`
#'
#' [make_sum in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sum.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
#' Required features: `contrib`
#'
#' [make_sum_of_squared_deviations in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_sum_of_squared_deviations.html)
#'
#' **Citations:**
#'
#' * [CSVW22 Widespread Underestimation of Sensitivity...](https://arxiv.org/pdf/2207.10635.pdf)
...
make_sum_of_squared_deviations <- function(
  ...
  # Standardize type arguments.
  .S <- rt_parse(type_name = .S, generics = list(".T"))
  .T <- rt_canon(get_atom(get_type(input_domain)))
  .S <- rt_substitute(.S, .T = .T)
...
#' Required features: `contrib`
#'
#' [make_unordered in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_unordered.html)
#'
#' **Supporting Elements:**
#'
#' * Input Domain:   `D`
...
#' **Why honest-but-curious?:**
#'
#' This constructor only returns a valid transformation if for every pair of elements \eqn{x, x'} in `input_domain`,
...
#' if \eqn{x, x'} are `d_in`-close under `input_metric`, `stability_map(d_in)` does not raise an exception,
#' and `stability_map(d_in) <= d_out`,
#' then `function(x), function(x')` are d_out-close under `output_metric`.
#'
#' In addition, for every element \eqn{x} in `input_domain`, `function(x)` is a member of `output_domain` or raises a data-independent runtime exception.
#'
...
#' @return Transformation
#' @export
make_user_transformation <- function(
  input_domain,
  input_metric,
  output_domain,
  output_metric,
  ...
  log_ <- new_constructor_log("make_user_transformation", "transformations", new_hashtab(
  ...
  # Call wrapper function.
  output <- .Call(
    "transformations__make_user_transformation",
...
#' @return Transformation
#' @export
then_user_transformation <- function(
  lhs,
  input_domain,
  input_metric,
  output_domain,
  ...
  log_ <- new_constructor_log("then_user_transformation", "transformations", new_hashtab(
    list("input_domain", "input_metric", "output_domain", "output_metric", "function", "stability_map"),
    list(input_domain, input_metric, output_domain, output_metric, function_, stability_map)
  ))
...
#' Required features: `contrib`
#'
#' [make_variance in Rust documentation.](https://docs.rs/opendp/0.15.0-nightly.20260530.1/opendp/transformations/fn.make_variance.html)
#'
#' **Citations:**
#'
